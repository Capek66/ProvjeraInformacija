        ...
        <section>
            ...
            <div class="forma">
                ...
                <form id="dodaj_recenzenta" method="post" name="forma_dodaj_recenzenta" action="./skripte/azurirajRecenzenta.php" novalidate>
                    <input type="hidden" id="vijestID" name="id" value="{$vijest_id}">
                    <label for="recenzent">Moderatori kategorije</label><br>
                    <input kategorija="{$kategorija_id}" type="text" id="recenzentForma" name="recenzent" list="moguciRecenzenti"><br>
